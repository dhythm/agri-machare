...
import { TransportInquiryForm } from './transport-inquiry-form'

afterEach(() => vi.unstubAllGlobals())

describe('TransportInquiryForm', () => {
  it('posts a question and links to the thread', async () => {
    ...
    render(
      <QueryClientProvider client={new QueryClient()}>
        <TransportInquiryForm jobId="tj-01" />
      </QueryClientProvider>,
    )
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      '/api/transport/jobs/tj-01/inquiries',
